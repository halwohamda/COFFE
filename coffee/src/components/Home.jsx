...
import img from '../assets/1pict.png'
  ...
  return (
    <div className='min-h-screen flex flex-col justify-center lg:flex-row lg:justify-between items-center  lg:px-32 px-5 gap-10 bg-gradient-to-r from-[#FFDCAB] to-[#AB6B2E]'>
        <div className='w-full lg:w-2/4 space-y-4 mt-14 lg:mt-0 '>
                ...
                <p>Bost your productivity build your mood with glass of coffee in the morning </p>
                <div className='flex flex-row gap-6 '>
                        <Button title="ADD TO THE CARD"/>
        ...
        <div className='relative'>
               ...
               <div className='absolute bg-white px-8 py-2 bottom-0 -laft-10 rounded-full'>
                <h2>cappuccino</h2>
               </div>
        </div>
